...
export function ProgramSchool() {
    const { school } = whatWeDo;

    return (
        <section id="school" className="bg-cream-soft py-24 relative overflow-hidden">
                ...
                <div className="grid gap-16 lg:grid-cols-[1.1fr_1fr] items-start">
                    ...
                    <div className="order-2">
                        ...
                        <h2 className="mt-4 mb-5.5 font-display text-[clamp(38px,4.4vw,60px)] font-normal leading-[1.04] tracking-[-0.022em] text-balance text-charcoal">
                            {school.title.before}
                            <em className="text-terracotta italic">{school.title.em}</em>
                        </h2>
                        ...
                        {/* pb-stats — alt variant uses ocean for stat values */}
                            ...
                            {school.stats.map((stat, idx) => (
                                <div
                                    ...
                                    className={[
                                        ...
                                        .join(" ")}
                                >
                                    <div className="font-display text-[32px] leading-none tracking-[-0.01em] text-ocean">
                                        {stat.value}
                                    </div>
